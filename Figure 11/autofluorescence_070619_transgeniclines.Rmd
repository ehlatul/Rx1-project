...
setwd("~/Desktop/NEW Rx1/Figures /Figure 11")


#Read in different sheets 
read0<-read_excel("autofluorescence-T=0_070619.xlsx", skip=40, sheet=3)
read0<-rbind(read0, read_excel("autofluorescence-T=0_070619.xlsx", skip=40, sheet=2))
read1<-read_excel("autofluorescence-T=1_070619.xlsx", skip=40, sheet=3)
read1<-rbind(read1, read_excel("autofluorescence-T=1_070619.xlsx", skip=40, sheet=2))
read2<-read_excel("autofluorescence-T=2_070619.xlsx", skip=40, sheet=3)
read2<-rbind(read2, read_excel("autofluorescence-T=2_070619.xlsx", skip=40, sheet=2))
read3<-read_excel("autofluorescence-T=3_070619.xlsx", skip=40, sheet=3)
read3<-rbind(read3, read_excel("autofluorescence-T=3_070619.xlsx", skip=40, sheet=2))
read4<-read_excel("autofluorescence-T=4_070619.xlsx", skip=40, sheet=3)
read4<-rbind(read4, read_excel("autofluorescence-T=4_070619.xlsx", skip=40, sheet=2))
read5<-read_excel("autofluorescence-T=5_070619.xlsx", skip=40, sheet=3)
read5<-rbind(read5, read_excel("autofluorescence-T=5_070619.xlsx", skip=40, sheet=2))
read6<-read_excel("autofluorescence-T=6_070619.xlsx", skip=40, sheet=3)
read6<-rbind(read6, read_excel("autofluorescence-T=6_070619.xlsx", skip=40, sheet=2))
